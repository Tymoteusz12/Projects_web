        ...
        components: [
            {
                ...
                content: {
                    ...
                    vid1: {
                        vidSrc: [require('./videos/cpp/Solar_System/General_Overview.mp4'), require('./videos/cpp/Solar_System/Sun_and_Earth.mp4'), require('./videos/cpp/Solar_System/Asteroid_belt.mp4'), require('./videos/cpp/Solar_System/Planets.mp4')],
                    ...
                    vid2: {
                        vidSrc: [require('./videos/cpp/Instancing/Instancing.mp4')],
                    ...
                    vid3: {
                        vidSrc: [require('./videos/cpp/Playground/General_Overview.mp4'), require('./videos/cpp/Playground/Cube.mp4'), require('./videos/cpp/Playground/Blending.mp4')],
            ...
            },
            {
                ...
                content: {
                    ...
                    vid1: {
                        vidSrc: [require('./videos/python/golf_ball.mp4')],
                    ...
                    vid2: {
                        vidSrc: [require('./videos/python/gravity_and_object.mp4')],
                        vidLabels:['Project overview'],
                    },
                    ...
                    vid3: {
                        vidSrc: [require('./videos/python/Space_invaders.mp4')],
                        vidLabels:['Project overview'],
                    },
                }
            },
            {
                ...
                content: {
                    ...
                    vid1: {
                        vidSrc: [require('./videos/web_dev/burger_builder/General_view.mp4'), require('./videos/web_dev/burger_builder/Ordering_Burger.mp4'), require('./videos/web_dev/burger_builder/Data_comparison.mp4'), require('./videos/web_dev/burger_builder/Routing.mp4') , require('./videos/web_dev/burger_builder/Firebase_check.mp4')],
                    ...
                    vid3: {
                        vidSrc: [require('./videos/web_dev/simple_spa/simple_spa.mp4'), require('./videos/web_dev/simple_spa/web_menu.mp4')],
